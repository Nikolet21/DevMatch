...
<template>
  <div class="min-h-screen bg-gradient-to-br from-blue-100 via-indigo-500 to-purple-100 py-16">
    <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-16 xl:px-24">
      ...
      <button
        @click="goBack"
        class="mb-8 inline-flex items-center px-5 py-2.5 bg-white/90 backdrop-blur-sm text-indigo-600 rounded-xl hover:bg-white transition-all duration-200 shadow-md hover:shadow-lg transform hover:scale-[1.02]"
      >
      ...
      <div v-else-if="developer" class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-start">
        ...
        <div class="lg:col-span-7 space-y-8">
          ...
          <div class="bg-white/90 shadow-xl rounded-3xl p-8 backdrop-blur-sm transform hover:scale-[1.01] transition-all duration-300 border border-white/30">
              ...
              <div class="flex items-start space-x-8">
                ...
                <div class="flex-1 space-y-4">
                  <div class="flex justify-between items-start">
                    <div>
                      <h1 class="text-4xl font-bold bg-gradient-to-r from-indigo-600 to-purple-700 bg-clip-text text-transparent tracking-tight">{{ developer.name }}</h1>
                  ...
                  <div class="flex flex-wrap gap-2">
                    <span v-for="skill in developer.skills" :key="skill"
                      class="px-4 py-1.5 rounded-full text-sm font-medium bg-indigo-100 text-indigo-800 hover:bg-indigo-200 transition-all duration-200 shadow-sm transform hover:scale-105"
                    >
                      {{ skill }}
                    </span>
                  </div>
          ...
          <!-- About Section -->
          <div class="bg-white/90 shadow-xl rounded-3xl p-8 backdrop-blur-sm transform hover:scale-[1.01] transition-all duration-300 border border-white/30">
            <h3 class="text-2xl font-bold bg-gradient-to-r from-indigo-600 to-purple-700 bg-clip-text text-transparent mb-6">About</h3>
            <p class="text-gray-600 leading-relaxed">{{ developer.bio }}</p>
          </div>

          <!-- Skills Section -->
          <div class="bg-white/90 shadow-xl rounded-3xl p-8 backdrop-blur-sm transform hover:scale-[1.01] transition-all duration-300 border border-white/30">
            <h3 class="text-2xl font-bold bg-gradient-to-r from-indigo-600 to-purple-700 bg-clip-text text-transparent mb-6">Skills</h3>
          ...
          <!-- Contact Information -->
          <div class="bg-white/90 shadow-xl rounded-3xl p-8 backdrop-blur-sm transform hover:scale-[1.01] transition-all duration-300 border border-white/30">
            <h3 class="text-2xl font-bold bg-gradient-to-r from-indigo-600 to-purple-700 bg-clip-text text-transparent mb-6">Contact Information</h3>
          ...
          <div class="bg-white/90 shadow-xl rounded-3xl p-8 backdrop-blur-sm transform hover:scale-[1.01] transition-all duration-300 border border-white/30">
            <h3 class="text-2xl font-bold bg-gradient-to-r from-indigo-600 to-purple-700 bg-clip-text text-transparent mb-6">Social Links</h3>
            <div class="flex flex-col space-y-4">
              <a
                ...
                class="flex items-center space-x-3 px-4 py-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors duration-200 group"
              >
                <svg class="w-6 h-6 text-gray-700 group-hover:text-indigo-600 transition-colors" fill="currentColor" viewBox="0 0 24 24">
                ...
                <span class="text-gray-700 font-medium group-hover:text-indigo-700 transition-colors">GitHub Profile</span>
              </a>
              <a
              ...
              >
                ...
                <span class="text-gray-700 font-medium group-hover:text-indigo-700 transition-colors">LinkedIn Profile</span>
              </a>
            </div>
          </div>
        </div>
        ...
        <div class="lg:col-span-5 space-y-8">
          <!-- Album Section -->
          <div class="bg-white/90 shadow-xl rounded-3xl p-8 backdrop-blur-sm transform hover:scale-[1.01] transition-all duration-300 border border-white/30">
            <h3 class="text-2xl font-bold bg-gradient-to-r from-indigo-600 to-purple-700 bg-clip-text text-transparent mb-6">Portfolio Album</h3>
